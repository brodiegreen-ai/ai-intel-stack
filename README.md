...
This is a working “AI daily digest stack” that will eventually:
...
Policy, Safety & Industry Moves

What This Means for Brodie (Action Ideas)
...
Google added Cinematic Video Overviews to NotebookLM: a three-model stack (Gemini 3, Nano Banana Pro, Veo 3) that turns documents into short, fully animated explainer videos instead of narrated slideshows.

2. Agents, Tools & Workflows

Workflow: you upload sources (PDFs, Docs, transcripts), Gemini 3 acts as a creative director deciding narrative and emphasis, Nano Banana Pro generates custom imagery, and Veo 3 stitches it into fluid, documentary-style video.

3. Business & Strategy

At launch, Cinematic is locked to the $249.99/mo Google AI Ultra plan, but that price includes Gemini 3 Deep Think, Veo 3, Flow editor, and large storage; the clearest ROI is for teams turning dense specs/docs into internal explainers and sales enablement content.

4. Policy, Safety & Industry Moves

Google runs this entirely on its own cloud and tags visuals with SynthID-style watermarks so AI output can be recognised later, which helps provenance and trust but means all data flows through Google’s stack and users are locked to Gemini rather than choosing their own models.

5. What This Means for Brodie (Action Ideas)

Treat “LLM as creative director + specialist models as executors” as a reusable pattern for your own stacks (for example: newsletter director → email sender, research director → chart generator).

When it becomes affordable or gets a trial, test NotebookLM (or similar tools) to turn planner instructions or Etsy listing copy into quick educational videos for listings, onboarding, or YouTube.

Keep a running list of “videos that don’t exist because they’re too hard to make” (ING help hub flows, planner walk-throughs, AI-digest explainers); those are prime candidates for tools like this.

Project goals (2026)
Build a working AI daily digest system that briefs me on the most important AI developments and how they affect my career and businesses.
